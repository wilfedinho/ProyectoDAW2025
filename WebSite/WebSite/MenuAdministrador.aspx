...
<body>
    <form id="form1" runat="server">
        ...
        <div id="navbarPrincipal" runat="server" class="navbar">
            ...
            <asp:Button CssClass="nav-item" ID="btnGestionPermisos" runat="server" Text="Gestión Permisos" OnClick="btnPermisos_Click" CausesValidation="false" data-key="btn_permisos"/>
